    ...
    <>
      <div className='home-container' id="topOfPage">
        ...
        <div className="home-btns">
          ...
          <Button className='btns play-btn' buttonStyle='btn-outline' buttonSize='btn-large' destination='/sign-up'>
            Sign Up Now!
          </Button>
          <Button className='btns play-btn' buttonStyle='btn-outline' buttonSize='btn-large' destination='/Game'>
